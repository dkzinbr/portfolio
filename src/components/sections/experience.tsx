...
import { education, experiences, workingPrinciples } from "@/src/data/experience";
...
export default function Experience() {
  return (
    <Section
      ...
      title="Experiência entre desenvolvimento, dados e suporte."
      description="Atuações que fortaleceram minha visão de produto, minha base técnica e a capacidade de transformar necessidades em entregas."
    >
      <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
          ...
          <div className="space-y-5">
            {experiences.map((experience) => (
              <article
                ...
                className="relative overflow-hidden rounded-2xl border border-line bg-surface/55 p-7 md:p-9"
              >
                <div
                  aria-hidden="true"
        ...
        <Reveal delay={100}>
          <div>
            <div className="mb-10 rounded-2xl border border-line bg-surface/45 p-6">
              <p className="font-mono text-[0.65rem] uppercase tracking-[0.16em] text-brand-light">
                Formação
              </p>
              <h3 className="mt-4 text-lg font-semibold text-white">{education.course}</h3>
              <p className="mt-2 text-sm text-slate-300">
                {education.institution} · {education.modality}
              </p>
